...
export const generateStudentRegistrationPDF = async (formData: Partial<Student>, school?: any) => {
  ...
  autoTable(doc, {
    ...
    body: [
      ...
      [{ content: formatCell('TIPO CERTIDÃO', formData.tipoCertidao) }, { content: formatCell('MODELO', formData.modeloCertidao) }, { content: formatCell('NÚMERO CERTIDÃO', formData.certidaoNumero), colSpan: 2 }, { content: formatCell('DATA CERT.', formData.certidaoData) }],
