...
$pattern = '(?ims)<h3[^>]*Parâmetros do Sistema</h3>'

$newCard = '<h3 className="text-lg font-bold text-slate-900 dark:text-white flex items-center gap-2"><School size={20} className="text-blue-600" /> Infraestrutura e Atendimento</h3>
...
if ($content -match $pattern) {
    ...
    $content = $content -replace $pattern, $newCard
